            ...
            >
              ...
              >
                <span style={{
                  ...
                  lineHeight: 1,
                  color: c,
                  textShadow: `0 0 8px currentColor, 0 0 20px currentColor, 0 0 18px ${c}99`,
                }}>
                  {s.kanji}
                </span>
                <span style={{
      ...
      >
        <h1
          style={{
            ...
            color: '#F0D080',
            textShadow: '0 0 8px currentColor, 0 0 20px currentColor, 0 0 40px rgba(240,208,128,0.5), 0 2px 10px rgba(0,0,0,0.85)',
            letterSpacing: 4,
            lineHeight: 1.1,
            margin: 0,
          }}
        >
          BitmojiGuy 5 Min Credit Tool
        </h1>
        ...
        <p
          style={{
            ...
            color: '#F5E6C8',
            letterSpacing: 3,
            textShadow: '0 0 8px currentColor, 0 0 20px currentColor, 0 2px 10px rgba(0,0,0,0.85)',
            margin: 0,
          }}
        >
          5 Min. 5 Clicks. Credit Improved.
        </p>
        ...
        >
          ...
          <p
            style={{
              ...
              lineHeight: 1,
              margin: 0,
              textShadow: '0 0 8px currentColor, 0 0 20px currentColor, 0 0 20px rgba(240,208,128,0.4)',
            }}
          >
            $24.99
          </p>
        ...
        >
          Begin Your Credit Journey &rarr;
        </button>
        ...
        <div style={{
          ...
          <div style={{
            ...
            fontSize: 14,
            letterSpacing: 2,
            textShadow: '0 0 8px currentColor, 0 0 20px currentColor, 0 2px 8px rgba(0,0,0,0.8)',
            backdropFilter: 'blur(3px)',
          }}>
        ...
        <button
          ...
          onMouseEnter={(e) => {
            ...
            e.currentTarget.style.textShadow = '0 0 8px currentColor, 0 0 20px currentColor, 0 0 10px rgba(201,168,76,0.4)'
          }}
          onMouseLeave={(e) => {
            e.currentTarget.style.color = '#8A8278'
            e.currentTarget.style.borderColor = 'rgba(138,130,120,0.25)'
            e.currentTarget.style.textShadow = '0 0 8px currentColor, 0 0 20px currentColor'
          }}
        >
          Admin Dashboard
        </button>
